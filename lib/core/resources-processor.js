...
class ResourcesProcessor {
    ...
    async processResource(resource) {
        ...
        //Load the object
        await this.loaderStep.loadResource(currObj);
    ...
    async run() {
        ...
        try {
            ...
            const pipelinedResources = resources.map(async (resource) => {
                ...
                if (this.resourcesProcessed % 10 === 0) {
